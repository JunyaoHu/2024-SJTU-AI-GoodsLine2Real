...
class ControlLDM(LatentDiffusion):
    ...
    def log_local(self, result_root, images, batch_id):
        root = result_root
        for k in images:
            bs = images[k].shape[0]
            for image_idx in range(bs): 
                ...
                # path = os.path.join(root, f"{batch_id[image_idx]}_{k}.jpg")
                path = os.path.join(root, f"{batch_id[image_idx]}.jpg")
    ...
    def shared_step_test(self, batch, batch_idx):
        ...
        self.log_local(f"./log_valid/1015-2017/Realistic Drawing", images, batch["id"])
